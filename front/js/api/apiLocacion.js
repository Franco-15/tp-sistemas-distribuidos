...
export function getLoc() { 
    const mockData = [
        { id: 'cee1f9bf-6e42-4071-859a-82d71e231cc1', lat: -38.00413285734509, long: -57.55136976361025 , description: "Casa grego", animal: [{ id: '11:5e:e7:84:c4:f6', nombre: "Grego", description: "Vaca" },
            { id: '7c:0a:3f:83:db:93', nombre: "Alan", description: "Goat" }] },
        { id: '32c7e94b-2b08-4ff5-80e9-ecb0f7795425', lat: -38.-37.959956981123014, long: -57.54691270133813 , description: "Casa juli", animal: [{ id: 'c2:5a:3d:ae:10:28', nombre: "Tomi", description: "Gallina" }] },
